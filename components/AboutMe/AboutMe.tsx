...
export default function AboutMe() {
  return (
    <div
      ...
      id="about"
    >
      <div className="mx-auto flex max-w-[1160px] flex-col items-center min-[601px]:flex-row min-[601px]:items-stretch">
      ...
      <div className="mx-auto flex max-w-[1160px] flex-col content-center justify-center text-center">
