...
const ExperienceCard = ({ item }: ExperienceCardProps) => {
  ...
  return (
    <article className="relative mx-auto my-[18px] max-w-[1040px] rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-4 text-[var(--text-primary)] min-[601px]:p-[18px]">
